    ...
    return (
        <>
            <div className="flex justify-between">
                ...
                <button type="button" className="flex items-center text-sm py-1 px-4 rounded-sm text-white bg-gray-600 hover:bg-gray-700 " onClick={() => addQuestion(myQuestions.length)}>
                    <PlusIcon />
                    Add Question
                </button>
            </div>
